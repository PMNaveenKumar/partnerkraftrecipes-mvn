...
<title>BugException (FMPP 0.9.15 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="BugException (FMPP 0.9.15 API)";
        }
    }
    catch(err) {
    }
...
<li><a href="class-use/BugException.html">Use</a></li>
...
<div class="subNav">
<ul class="navList">
<li><a href="../../fmpp/util/BorderedReader.html" title="class in fmpp.util"><span class="typeNameLink">Prev&nbsp;Class</span></a></li>
<li><a href="../../fmpp/util/DataLoaderUtil.html" title="class in fmpp.util"><span class="typeNameLink">Next&nbsp;Class</span></a></li>
</ul>
<ul class="navList">
<li><a href="../../index.html?fmpp/util/BugException.html" target="_top">Frames</a></li>
<li><a href="BugException.html" target="_top">No&nbsp;Frames</a></li>
</ul>
...
<li><a href="#methods.inherited.from.class.fmpp.util.RuntimeExceptionCC">Method</a></li>
</ul>
<ul class="subNavList">
<li>Detail:&nbsp;</li>
<li>Field&nbsp;|&nbsp;</li>
...
<h2 title="Class BugException" class="title">Class BugException</h2>
</div>
...
<li>
<ul class="inheritance">
<li><a href="../../fmpp/util/RuntimeExceptionCC.html" title="class in fmpp.util">fmpp.util.RuntimeExceptionCC</a></li>
<li>
<ul class="inheritance">
<li>fmpp.util.BugException</li>
</ul>
</li>
</ul>
</li>
...
extends <a href="../../fmpp/util/RuntimeExceptionCC.html" title="class in fmpp.util">RuntimeExceptionCC</a></pre>
<div class="block">A bug has been detected.</div>
<dl>
<dt><span class="seeLabel">See Also:</span></dt>
<dd><a href="../../serialized-form.html#fmpp.util.BugException">Serialized Form</a></dd>
</dl>
</li>
</ul>
</div>
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a href="../../fmpp/util/BugException.html#BugException-java.lang.String-">BugException</a></span>(<a href="http://docs.oracle.com/javase/8/docs/api/java/lang/String.html?is-external=true" title="class or interface in java.lang">String</a>&nbsp;message)</code>&nbsp;</td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a href="../../fmpp/util/BugException.html#BugException-java.lang.String-java.lang.Throwable-">BugException</a></span>(<a href="http://docs.oracle.com/javase/8/docs/api/java/lang/String.html?is-external=true" title="class or interface in java.lang">String</a>&nbsp;message,
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.fmpp.util.RuntimeExceptionCC">
<!--   -->
</a>
<h3>Methods inherited from class&nbsp;fmpp.util.<a href="../../fmpp/util/RuntimeExceptionCC.html" title="class in fmpp.util">RuntimeExceptionCC</a></h3>
<code><a href="../../fmpp/util/RuntimeExceptionCC.html#getCause--">getCause</a>, <a href="../../fmpp/util/RuntimeExceptionCC.html#printStackTrace--">printStackTrace</a>, <a href="../../fmpp/util/RuntimeExceptionCC.html#printStackTrace-java.io.PrintStream-">printStackTrace</a>, <a href="../../fmpp/util/RuntimeExceptionCC.html#printStackTrace-java.io.PrintWriter-">printStackTrace</a></code></li>
</ul>
<ul class="blockList">
...
<a name="BugException-java.lang.String-">
<!--   -->
</a>
<ul class="blockList">
<li class="blockList">
