...
<title>DebuggerClient (FreeMarker 2.3.21 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="DebuggerClient (FreeMarker 2.3.21 API)";
        }
    }
    catch(err) {
    }
...
<div class="subNav">
<ul class="navList">
<li><a href="../../freemarker/debug/Debugger.html" title="interface in freemarker.debug"><span class="typeNameLink">Prev&nbsp;Class</span></a></li>
<li><a href="../../freemarker/debug/DebuggerListener.html" title="interface in freemarker.debug"><span class="typeNameLink">Next&nbsp;Class</span></a></li>
</ul>
<ul class="navList">
<li><a href="../../index.html?freemarker/debug/DebuggerClient.html" target="_top">Frames</a></li>
...
<div class="block">Connects to the FreeMarker debugger service running on a specific host
 ...
 <a href="../../freemarker/debug/Debugger.html#DEFAULT_PORT"><code>Debugger.DEFAULT_PORT</code></a>.</div>
<dl>
<dt><span class="paramLabel">Parameters:</span></dt>
<dd><code>host</code> - the host address of the machine where the debugger service is
 running.</dd>
<dd><code>port</code> - the port of the debugger service</dd>
<dd><code>password</code> - the password required to connect to the debugger service</dd>
