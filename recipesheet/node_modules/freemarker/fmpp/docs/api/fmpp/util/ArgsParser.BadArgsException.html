...
<title>ArgsParser.BadArgsException (FMPP 0.9.15 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="ArgsParser.BadArgsException (FMPP 0.9.15 API)";
        }
    }
    catch(err) {
    }
...
<li><a href="class-use/ArgsParser.BadArgsException.html">Use</a></li>
...
<div class="subNav">
<ul class="navList">
<li><a href="../../fmpp/util/ArgsParser.html" title="class in fmpp.util"><span class="typeNameLink">Prev&nbsp;Class</span></a></li>
<li><a href="../../fmpp/util/ArgsParser.OptionDefinition.html" title="class in fmpp.util"><span class="typeNameLink">Next&nbsp;Class</span></a></li>
</ul>
<ul class="navList">
<li><a href="../../index.html?fmpp/util/ArgsParser.BadArgsException.html" target="_top">Frames</a></li>
...
<h2 title="Class ArgsParser.BadArgsException" class="title">Class ArgsParser.BadArgsException</h2>
</div>
...
<li>
<ul class="inheritance">
<li>fmpp.util.ArgsParser.BadArgsException</li>
</ul>
</li>
</ul>
</li>
...
<hr>
<br>
<pre>public static class <span class="typeNameLabel">ArgsParser.BadArgsException</span>
...
<div class="block">The user has entered invalid options in the command-line.
 Use the <code>getMessage()</code> method to get the description of the
 problem, that you can directly print to the terminal for the user.</div>
<dl>
<dt><span class="seeLabel">See Also:</span></dt>
<dd><a href="../../serialized-form.html#fmpp.util.ArgsParser.BadArgsException">Serialized Form</a></dd>
</dl>
</li>
</ul>
</div>
